...
uint256 hashGenesisBlock("0xd2e1a12d8bf0b4de3ab53ae2415ba9aec53ff73ed0cd757cc403f3e967f24a02");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(520134678); // HopeCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "HopeCoin Signed Message:\n";
...
{
    // HopeCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 8000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 250000); // HopeCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 43200; // HopeCoin: 3.5 days
static const int64 nTargetSpacing = 150; // HopeCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // HopeCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // HopeCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // HopeCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8933bb50ad200941aa76b8e0e3ca37906a7034bdbdac55b2f502c61c816b233f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "HopeCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 8000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("5bc0d2c0b720d9ba4e88e0c53f1bf38f1eafcf116261eb31a3a54b5c832ebfa30e3935188f43db7751958c260064197bac1afd1ace5c3b96f639013569e0682f38") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1474156540;
        block.nBits    = 520134678;
        block.nNonce   = 3723462185;

        if (fTestNet)
        {
            block.nTime    = 1474156540;
            block.nNonce   = 2435413049;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4fcca7915744f42b15a4ac4b25ebf95858392bc9a32635c23fc169f2eba3d3fc"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // HopeCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("HopeCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("HopeCoinMiner : ProcessBlock, block not accepted");
    }
